...
export default function ForgotForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-primary-50 primary-950/20 text-primary mb-6">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {error && (
        <div className="rounded-xl bg-red-50 p-3.5 text-xs font-semibold text-red-700 dark:text-red-400 border border-red-100 dark:border-red-900/30 animate-shake">
          {error}
        </div>
      )}
