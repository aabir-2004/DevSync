      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 rounded-full bg-zinc-50 border border-zinc-200/60 text-[10px] font-bold text-zinc-600 dark:bg-zinc-900/40 dark:border-zinc-800 dark:text-zinc-300 hover:text-primary hover:border-primary-100 transition-colors"
          >
